...
--
-- Hôte : localhost
-- Généré le : mar. 10 mars 2026 à 13:41
...
INSERT INTO `animaux` (`id`, `reference_race`, `date_de_naissance`, `sexe`, `pseudo`, `commentaire`) VALUES
(1, 1, '2018-06-10', 'M', 'Simba', 'Lion dominant'),
(2, 2, '2020-03-15', 'F', 'Marty', 'Zebre tres rapide'),
(3, 4, '2019-08-20', 'M', 'Flipper', 'Tres joueur');
...
(1, 'Dupont', 'Jean', '1980-05-12', 'H', 'jdupont', 'admin123', 'Directeur', 3200.00),
(2, 'Martin', 'Claire', '1992-09-03', 'F', 'cmartin', 'test123', 'Employe', 1900.00);
...
INSERT INTO `soigneurs` (`id`, `reference_personnel`, `reference_race`) VALUES
(1, 2, 1),
(2, 2, 2);
